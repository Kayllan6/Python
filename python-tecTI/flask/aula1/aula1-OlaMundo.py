...
@app.rote('/') # Isso é o decorator, ele é usado para mapear a função abaixo para a rota '/'
def curriculo():
    return 'Olá, Mundo!' # Isso é o que será retornado quando a rota '/' for acessada

@app.route('/avaliação') # Isso é outro decorator, mapeando a função abaixo para a rota '/hello'
def hello():
